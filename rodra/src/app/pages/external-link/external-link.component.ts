...
export class ExternalLinkComponent implements OnInit {
  ...
  externalLink=[
    ...
    {url:"https://pcdaopune.nic.in/",name:"PCDA(Officers)"},
    ...
    {url:"https://sainiksamachar.nic.in/",name:"Sainik Samachar"},
    {url:"https://www.mod.gov.in/",name:"Min of Defence"},
    {url:"https://www.desw.gov.in/",name:"Dept of ESW"},
    {url:"https://www.pensionseva.sbi/WebPages/Login/Login.aspx",name:"SBI Pension Seva"},
  ]
}
